    ...
    public partial class ReservationForm : Form
    {
        ...
        private void button_save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (reservation.addReserv(guestId, roomNo, dIn, dOut) && reservation.setReservRoom(roomNo, "Ada"))
                    {
                        getReservTable();
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (reservation.removeReserv(reserId)&& reservation.setReservRoom(rno,"Kosong"))
                {
                    getReservTable();
