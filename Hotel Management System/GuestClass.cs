...
namespace Hotel_Management_System
{
    ...
    class GuestClass
    {
        ...
        {
            string insertQuerry = "INSERT INTO `clients`(`id`, `name`, `phone`, `city`) VALUES(@id,@fname,@ph,@ct)";
        ...
        {
            string editQuerry = "UPDATE `clients` SET `name`=@fname,`phone`=@ph,`city`=@ct WHERE `id`=@id";
